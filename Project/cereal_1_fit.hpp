...
namespace cereal_1_fit_model_namespace {
...
class cereal_1_fit_model final : public model_base_crtp<cereal_1_fit_model> {
 ...
 public:
  ...
  inline std::string model_name() const final { return "cereal_1_fit_model"; }
  ...
  cereal_1_fit_model(stan::io::var_context& context__,
    ...
    static constexpr const char* function__ = "cereal_1_fit_model_namespace::cereal_1_fit_model";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "cereal_1_fit_model_namespace::log_prob";
    (void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "cereal_1_fit_model_namespace::write_array";
    (void) function__;  // suppress unused var warning
    ...
    try {
      ...
      log_lik = stan::math::normal_lpdf<false>(calories, mu, sigma);
      double calorie = std::numeric_limits<double>::quiet_NaN();
      current_statement__ = 4;
      calorie = stan::math::normal_rng(mu, sigma, base_rng__);
      out__.write(log_lik);
      out__.write(calorie);
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
  ...
  inline void get_param_names(std::vector<std::string>& names__) const {
    ...
    names__ = std::vector<std::string>{"mu", "sigma", "log_lik", "calorie"};
  ...
  inline void constrained_param_names(
    ...
    if (emit_generated_quantities__) {
      ...
      param_names__.emplace_back(std::string() + "calorie");
    }
  ...
  inline std::string get_constrained_sizedtypes() const {
    ...
    return std::string("[{\"name\":\"mu\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"calorie\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]");
...
using stan_model = cereal_1_fit_model_namespace::cereal_1_fit_model;
...
stan::math::profile_map& get_stan_profile_data() {
  return cereal_1_fit_model_namespace::profiles__;
}
