...
namespace cereal_3_fit_model_namespace {
...
class cereal_3_fit_model final : public model_base_crtp<cereal_3_fit_model> {
 ...
 public:
  ...
  inline std::string model_name() const final { return "cereal_3_fit_model"; }
  ...
  cereal_3_fit_model(stan::io::var_context& context__,
    ...
    static constexpr const char* function__ = "cereal_3_fit_model_namespace::cereal_3_fit_model";
    ...
    try {
      ...
      new (&sugars) Eigen::Map<Eigen::Matrix<double, -1, 1>>(sugars__.data(), N);
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "cereal_3_fit_model_namespace::log_prob";
    (void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "cereal_3_fit_model_namespace::write_array";
    (void) function__;  // suppress unused var warning
...
using stan_model = cereal_3_fit_model_namespace::cereal_3_fit_model;
...
stan::math::profile_map& get_stan_profile_data() {
  return cereal_3_fit_model_namespace::profiles__;
}
